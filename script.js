...
function sum() {
  ...
  // TODO: Лучше дать этим переменным более "говорящие" имена, помогающие определить их назначение в коде
  ...
  // TODO: Эти две строки можно сократить в одну, возвращая сразу результат выражения (return a + b).
